...
public class VelocityOverLifetimeSetting extends ToggleGroup {
    ...
    @Configurable(name = "photon.gui.editor.config.linear", tips = "photon.emitter.config.velocityOverLifetime.linear")
    ...
    @Configurable(name = "photon.gui.editor.config.orbital_mode", tips = "photon.emitter.config.velocityOverLifetime.orbitalMode")
    protected OrbitalMode orbitalMode = OrbitalMode.AngularVelocity;

    @Configurable(name = "photon.gui.editor.config.orbital", tips = "photon.emitter.config.velocityOverLifetime.orbital")
    ...
    @Configurable(name = "photon.gui.editor.config.offset", tips = "photon.emitter.config.velocityOverLifetime.offset")
    ...
    @Configurable(name = "photon.gui.editor.config.speed_modifier", tips = "photon.emitter.config.velocityOverLifetime.speedModifier")
