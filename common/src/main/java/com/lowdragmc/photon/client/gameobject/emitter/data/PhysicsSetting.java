...
public class PhysicsSetting extends ToggleGroup {
    ...
    @Configurable(name = "photon.gui.editor.config.has_collision", tips = "photon.emitter.config.physics.hasCollision")
    protected boolean hasCollision = true;
    @Configurable(name = "photon.gui.editor.config.removed_when_collided", tips = "photon.emitter.config.physics.removedWhenCollided")
    protected boolean removedWhenCollided = false;
    @Configurable(name = "photon.gui.editor.config.friction", tips = "photon.emitter.config.physics.friction")
    ...
    @Configurable(name = "photon.gui.editor.config.gravity", tips = "photon.emitter.config.physics.gravity")
    ...
    @Configurable(name = "photon.gui.editor.config.bounce_chance", tips = "photon.emitter.config.physics.bounceChance")
    ...
    @Configurable(name = "photon.gui.editor.config.bounce_rate", tips = "photon.emitter.config.physics.bounceRate")
    ...
    @Configurable(name = "photon.gui.editor.config.bounce_spread_rate", tips = "photon.emitter.config.physics.bounceSpreadRate")
